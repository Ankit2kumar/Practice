...
*/
            const calculateNow=function(arr){
                let sum=0
            ...
            //console.log(calculateNow([3,4,6]));
/*

9)
Create a function to test whether an array of integers of length 2 contains 1 or a 3. 
*/
            const test=function(arr2){
                if(arr2.includes(1 || 3))
                return true
                else 
                return false
            }
           // console.log(test([2,4,5,6,7,8,9,0]));
